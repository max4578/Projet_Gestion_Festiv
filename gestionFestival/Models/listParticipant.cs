...
namespace gestionFestival.Models
{
    public class listParticipant:DataContextDataContext
    {
        ...
        public List<CParticipant> GetList(int id)
        {
            ...
            {
                listPart.Add(new CParticipant(elem.idPersonnel, elem.nomPersonnel, elem.prenomPersonnel, elem.telephone, elem.dateNaissance, elem.email, elem.specialisation,elem.libelRole,(double)elem.salaireHoraire,(int)elem.nbrHeure));
            }
